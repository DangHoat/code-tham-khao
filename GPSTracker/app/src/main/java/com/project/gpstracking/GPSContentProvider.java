...
public class GPSContentProvider extends ContentProvider{
    ...
    public static final Uri CONTENT_URI =
            Uri.parse("content://com.project.gpstracking/gpstracked");
    @Override
    ...
    static {
        ...
        uriMatcher.addURI("com.project.gpstracking", "gpstracked", ALLROWS);
        uriMatcher.addURI("com.project.gpstracking", "gpstracked/#", SINGLE_ROW);
    }
    @Override
    public String getType(Uri url) {
        switch (uriMatcher.match(url)) {
            case ALLROWS: return "vnd.android.cursor.dir/vnd.gpstracker.gpstracked";
            case SINGLE_ROW: return "vnd.android.cursor.item/vnd.gpstracker.gpstracked";
    ...
    private static class MySQLiteOpenHelper extends SQLiteOpenHelper{
        private static final String DATABASE_NAME = "gpsTrackerDatabase.db";
        private static final int DATABASE_VERSION = 1;
        private static final String DATABASE_TABLE = "gpsTrackerItemTable";
